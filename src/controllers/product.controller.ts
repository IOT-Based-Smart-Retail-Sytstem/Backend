...
import { createProduct, getAllProducts, getProductById, getProductsByCategory, getProductsBySubCategory, searchForProduct, getProductStateCounts, updateProduct, getProductByBarcode ,  deleteProductById, restockProduct } from "../service/product.service";
